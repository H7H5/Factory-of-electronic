...
public class Save_integer
{
    ...
    {
        Insert_save_integer(unitySQLite, 1, 120, "money");        //поменять
        ...
        Insert_save_integer(unitySQLite, 5, 5, "sciense");         //поменять
        Insert_save_integer(unitySQLite, 6, 0, "learning");
        Insert_save_integer(unitySQLite, 7, 20, "diamonds");       //поменять
    }
